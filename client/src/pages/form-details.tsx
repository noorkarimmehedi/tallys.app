...
// Import form details components
// Note: These will be created in the next steps
const FormSubmissionsTable = ({ form, responses, isLoading }: { 
  form: Form; 
  responses: Response[];
  isLoading: boolean;
}) => {
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>View and manage all responses to this form.</CardDescription>
        </CardHeader>
        <CardContent>
          {isLoading ? (
                ...
                <table className="w-full">
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {responses.map((response) => (
                      <tr key={response.id}>
                        <td className="px-4 py-3 whitespace-nowrap text-sm font-medium text-gray-900">#{response.id}</td>
                        ...
                        {form.questions.map((question) => {
                          ...
                          return (
                            <td key={question.id} className="px-4 py-3 text-sm text-gray-500">
