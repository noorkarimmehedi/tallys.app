  ...
  return (
    <div className="border border-black/[0.2] dark:border-white/[0.2] flex flex-col items-start max-w-lg mx-auto p-4 relative md:h-[28rem] h-auto mb-2">
      ...
      <div className="w-full md:min-h-[16rem] min-h-[120px] flex items-center justify-center">
        <EvervaultCard text="tallys" className="md:h-60 h-28" />
      </div>

      <div className="mt-2 md:mt-6 dark:text-white text-black w-full">
        <h2 className="text-lg md:text-xl font-medium mb-1 md:mb-2">What is tallys?</h2>
        <p className="text-xs md:text-sm font-light mb-1 md:mb-2">
