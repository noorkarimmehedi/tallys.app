      ...
      <HighlightGroup className="group h-full">
        ...
        >
          <HighlighterItem className="rounded-3xl p-4">
            <div className="relative z-20 overflow-hidden rounded-3xl border border-slate-200 bg-white dark:border-slate-800 dark:bg-black md:h-[340px] h-auto">
              <Particles
              ...
              <div className="flex h-full justify-center">
                <div className="flex h-full flex-col justify-center gap-6 p-6 md:py-24">
                  <div className="flex flex-col items-center">
                    <h3 className="mt-4 pb-1 font-bold">
                      <span className="text-2xl md:text-3xl">
                        Sign in with Google
                      </span>
                    </h3>
                    <p className="mb-4 text-sm text-slate-500 text-center md:mt-2">
                  ...
                  <p className="text-xs text-slate-500 text-center pb-2 md:mt-6">
